...
<p>Aeronave</p></td>
      <td colspan="2"><select name="aeronave">
          ...
          <?
	 $query="SELECT voo,voo_dia_semna FROM aeronaves";
    ...
    <tr> 
      <td></td>
      <td><p>Hora partida</p></td>
      <td colspan="2"><p>
          <input name="hora_partida" type="text" size="22">
          Hs</p></td>
    </tr>
    <tr> 
      <td></td>
      <td><p>Tempo</p></td>
      <td colspan="2"><p>
          <input name="tempo_voo" type="text" size="22">
          Hs</p></td>
    </tr>
    <tr> 
      <td></td>
	...
	while ($linha = mysql_fetch_array($result)){
      ...
      echo "<td><input type='hidden' name='assentos_disp' value='".$linha['capacidade']."'></td>";
	  }
	  	    ?>
    </tr>
    <tr> 
