...
void(window.openr(url,'popwinpop','scrollbars=no,resizable=no,width=300,height=200'))
}
self.close();
}</script>
...
<tr> 
    <td width="35" bgcolor="#006699">
     <div align="center"><a href="calendario_de.php?mes_c=<? echo $prevmes; ?>&ano_c=<? echo $prevano; ?>"><img src="../../icones/adm/i_anterior_branco.gif" border="0"></a></div></td>
    <td colspan="5" bgcolor="#006699">
<div align="center">
        <p class='branco'><? echo $mesext." / ". $ano?></p>
      </div></td>
    <td width="35" bgcolor="#006699">
<div align="center"><a href="calendario_de.php?mes_c=<? echo $nextmes; ?>&ano_c=<? echo $nextano; ?>"><img src="../../icones/adm/i_proximo_branco.gif" border="0"></a></div></td>
  </tr>
  <tr> 
...
for($i = 2; $i < 33; $i++)
{
	...
	echo "<td><div align=center><a href='#' class='link2' onClick=\"continuar('insere_voo_diasemana.php?dia_de=".$linha."&mes_de=".$mes."&ano_de=".$ano.
	"&dia_ate=".$dia_ate."mes_de=".$mes_ate."&ano_ate=".$ano_ate."')\">".$linha."</a></div></td>";
