...
function mmLoadMenus() {
  ...
  mm_menu_0421112339_0.addMenuItem(mm_menu_0421112339_0_1);
...
<table width="778" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="780"><object width="779" height="80" hspace="0" vspace="0" align="bottom">
        <embed src="fatias/topo.swf" width="779" height="90" hspace="0" vspace="0" align="bottom"></embed></object></td>
  </tr>
  <tr> 
    <td bgcolor="#FFFFFF"> <table width="779" border="0" cellspacing="1" cellpadding="0">
        <tr> 
          <td width="130" height="20" bgcolor="#666600"> 
            <div align="center"><a href="#" name="link11" id="link1" onMouseOver="MM_showMenu(window.mm_menu_0421102600_0,-37,18,null,'link11')" onMouseOut="MM_startTimeout();">A 
              Empresa</a></div></td>
          <td width="130" bgcolor="#999900"> 
            <div align="center"><a href="#" name="link3" id="link2" onMouseOver="MM_showMenu(window.mm_menu_0421112339_0,-41,18,null,'link3')" onMouseOut="MM_startTimeout();">Servi&ccedil;os</a></div></td>
          ...
          <td width="130" bgcolor="#669933"> 
            <div align="center"><a href="#" name="link5" id="link7" onMouseOver="MM_showMenu(window.mm_menu_0421115204_0,-22,18,null,'link5')" onMouseOut="MM_startTimeout();">Compra 
              On-line</a></div></td>
          <td width="130" bgcolor="#669966"> 
            <div align="center"><a href="#" name="link10" id="link6" onMouseOver="MM_showMenu(window.mm_menu_0421145146_0,-30,19,null,'link10')" onMouseOut="MM_startTimeout();">Informa&ccedil;&otilde;es</a></div></td>
          <td bgcolor="#99CC66"> 
